...
if __name__ == "__main__":
    print ("OMGHAI!")
    items = [
             Sellable(name="+5 Dexterity Vest", sell_in=10, quality=20),
             AgedBrie(name="Aged Brie", sell_in=2, quality=0),
             Sellable(name="Elixir of the Mongoose", sell_in=5, quality=7),
             ...
             Sellable(name="Conjured Mana Cake", sell_in=3, quality=6),  # <-- :O
            ]
